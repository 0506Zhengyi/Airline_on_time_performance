...
## Graph5: Average delay of each state (mins)
```{r, include=FALSE}
usa <- df %>%
...
fig
```
## Graph6: Depature delay and arrival delay by airport (top10 and bottom10 )
```{r, include=FALSE}
...
## Graph7: Delay by hour/day of week
```{r, include=FALSE}
df71 <- df %>%
...
ggplot(data = df74) +
  ...
  labs(x = 'Time', y = 'Percentage of delayed flights', color = 'Airline',
       title = 'Percentage of Delayed Flight by Time of the Week',
